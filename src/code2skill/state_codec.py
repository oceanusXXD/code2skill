...
def source_summary_from_dict(data: dict[str, Any]) -> SourceFileSummary:
    return SourceFileSummary(
        ...
        call_targets=list(data.get("call_targets", [])),
        instantiated_classes=list(data.get("instantiated_classes", [])),
        raised_exceptions=list(data.get("raised_exceptions", [])),
        type_references=list(data.get("type_references", [])),
        data_flow_edges=list(data.get("data_flow_edges", [])),
        dynamic_imports=list(data.get("dynamic_imports", [])),
